...
namespace Yankees
{
    class Program
    {
        ...
        {
            Dictionary<int, RetiredPlayer> retiredYankes = new Dictionary<int, RetiredPlayer>
            {
                {3, new RetiredPlayer("Babe Ruth", 1948) },
                {4, new RetiredPlayer("Lou Cehrig", 1939) },
            ...
            foreach (int jerseyNumber in retiredYankes.Keys)
            {
                RetiredPlayer retiredPlayer = retiredYankes[jerseyNumber];
                Console.WriteLine($"{retiredPlayer.Name} #{jerseyNumber} retired in {retiredPlayer.YearRetired}");
            }
        }
    }
}
