...
namespace GoFish
{
    public class GameController
    {
        ...
        /// <summary>
        /// status property is important. The constructor, NextRound and NewGame methods
        /// update it so the app can use it to write messages for the player
        /// </summary>
        ...
        /// </summary>
        /// <param name="humanPlayer">Name of the humanPlayer</param>
        ...
        /// <summary>
        /// all of the computer players that have  cards play the next round. If the human
        /// is out of cards, then the deck is depleted and they play out the rest of the game
        /// </summary>
