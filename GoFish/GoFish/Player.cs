...
namespace GoFish
{
    public class Player
    {
        ...
        /// <summary>
        /// Pluralize a word, adding "s" if a value isn't equal to1
        /// </summary>
        ...
        /// <summary>
        /// When the player receives cards from another player, add them to the hand
        /// and pulls out any matching books
        /// </summary>
        /// <param name="cards">Stock to draw a card from</param>
