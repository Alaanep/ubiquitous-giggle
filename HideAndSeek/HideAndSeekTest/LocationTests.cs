...
namespace HideAndSeekTest
{
    ...
    public class LocationTests
    {
        ...
        /// <summary>
        /// Initializes each unit test by setting creating a new center location
        ...
        /// <summary>
        /// Make sure GetExit returns the location only if it exists
        /// </summary>
        [TestMethod]
        public void TestGetExit()
        {
            //this test will make sure the GetExit works
            var eastRoom = center.GetExit(Direction.East);
            Assert.AreEqual("East Room", eastRoom.Name);
            Assert.AreEqual(center, eastRoom.GetExit(Direction.West));
        ...
        /// <summary>
        /// Validates that each room's name and return exit is created correcly
        /// </summary>
        [TestMethod]
        public void TestReturnExits()
        {
            ...
            Assert.AreEqual(1, nw.ExitList.Count());
        ...
        /// <summary>
        /// Add a hall one of the rooms and make sure the hall room's names
